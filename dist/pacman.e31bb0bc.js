...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    key: "showGamesStatus",
    value: function showGamesStatus(gameWin) {
      var div = document.createElement('div');
      div.classList.add('add-status');
      div.innerHTML = "".concat(gameWin ? 'win!' : 'GAME OVER MAN!');
    ...
    key: "rotateDiv",
    value: function rotateDiv(post, deg) {
...
var startButon = document.querySelector('#start-button'); // Game Const

var POWER_PILL_TIME = 10000;
var GLOWBAL_SPEED = 80;

var gameBoard = _GameBoard.default.createGameBoard(gameGrid.LEVEL); // initial Setup
